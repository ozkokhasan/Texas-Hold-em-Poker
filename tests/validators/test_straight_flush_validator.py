...
from poker.validators import StraightFlushValidator, three_of_a_kind_validator
...
class StraightFlushValidatorTest(unittest.TestCase):
    ...
    def test_returns_that_there_are_five_consecutive_cards_with_same_suit(self):
