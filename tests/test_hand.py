...
class HandTest(unittest.TestCase):
    ...
    def test_figures_out_flush_is_the_best_hand(self):
        cards = [
    ...
    def test_figures_out_full_house_is_the_best_hand(self):
        cards = [
    ...
    def test_figures_out_four_of_a_kind_is_the_best_hand(self):
        cards = [
            Card(rank = "3", suit = "Clubs"),
            Card(rank = "3", suit = "Hearts"),
            Card(rank = "3", suit = "Spades"),
    ...
    def test_figures_out_straight_flush_is_the_best_hand(self):
        cards = [
            Card(rank = "3", suit = "Clubs"),
            Card(rank = "4", suit = "Clubs"),
    ...
    def test_figures_out_royal_flush_is_the_best_hand(self):
        cards = [
